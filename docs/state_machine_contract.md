...
3. **`onboarding_stage` (OB1–OB3)**, found in the EKA (Exercise/Knowledge/Activity) module's rules-table spreadsheet, was reviewed and confirmed **out of scope for dietetics** — EKA is a sibling module, not part of this repo's personalization logic.
